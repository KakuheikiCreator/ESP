...
/******************************************************************************/
/** 判定：who am i */
extern esp_err_t sts_lis3dh_who_am_i(ts_i2c_mst_address_t* ps_address);
/** 書き込み：レート */
extern esp_err_t sts_lis3dh_set_rate(ts_i2c_mst_address_t* ps_address, bool b_low_pwr, te_lis3dh_data_rate_t e_rate);
/** 書き込み：３軸の有効無効 */
extern esp_err_t sts_lis3dh_set_enable_axis(ts_i2c_mst_address_t* ps_address, bool b_x, bool b_y, bool b_z);
/** 書き込み：HPCF */
extern esp_err_t sts_lis3dh_set_hpcf(ts_i2c_mst_address_t* ps_address, te_lis3dh_hpf_mode_t e_hpf_mode, uint8_t u8_hpcf, bool b_fds);
/** 書き込み：データ更新方式 */
extern esp_err_t sts_lis3dh_set_upd_settings(ts_i2c_mst_address_t* ps_address, bool b_upd_type, bool b_format);
/** 書き込み：データレンジ */
extern esp_err_t sts_lis3dh_set_range(ts_i2c_mst_address_t* ps_address, te_lis3dh_range_t e_range, bool b_hr);
/** 書き込み：FIFOモード */
extern esp_err_t sts_lis3dh_set_fifo_mode(ts_i2c_mst_address_t* ps_address, te_lis3dh_fifo_mode_t e_fifo_mode);
/** 読み込み：FIFOカウント */
extern esp_err_t sts_lis3dh_fifo_cnt(ts_i2c_mst_address_t* ps_address, uint8_t* pu8_fifo_cnt);
/** 読み込み：ステータス */
extern esp_err_t sts_lis3dh_status(ts_i2c_mst_address_t* ps_address, uint8_t* pu8_status);
/** 読み込み：加速度（XYZ軸） */
extern esp_err_t sts_lis3dh_acceleration(ts_i2c_mst_address_t* ps_address, ts_lis3dh_axes_data_t* ps_axes_data);
